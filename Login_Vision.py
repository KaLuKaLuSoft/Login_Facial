...
from tkinter import * #parte grafica
import os #importar archivos y hacer comparaciones
import cv2 #procesamiento de imagenes igual que pyplot
from matplotlib import pyplot
from mtcnn.mtcnn import MTCNN
import numpy as np #operaciones con matrices
Seguna Prueba Mercurial 19
...
#------------------------------Vamos a capturar el rostro-----------------------------------------------------
    ...
    #Leemos el rostro y exportamos solo los pixeles que es del rostro
    def log_rostro(img, lista_resultados):
        ...
        for i in range(len(lista_resultados)):
            ...
            pyplot.axis('off')
            cara_reg = data[y1:y2, x1:x2]
            #Cambiamos el tamaño de la foto a 150 x 200
...
def pantalla_principal():
    ...
    pantalla.title("Inteligencia Artificial")       #Asignamos el titulo de la pantalla
    Label(text = "Login Inteligente", bg = "sky blue", width = "300", height = "2", font = ("Verdana", 13)).pack() #Asignamos caracteristicas de la ventana
